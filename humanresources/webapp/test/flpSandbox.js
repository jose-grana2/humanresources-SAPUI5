		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#rrhhhumanresources-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rrhhhumanresources-display": {
								"semanticObject": "rrhhhumanresources",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rrhh.humanresources",
									"url": sap.ui.require.toUrl("rrhh/humanresources")
								}
							}
						}
					}
